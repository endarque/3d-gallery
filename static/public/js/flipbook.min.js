...
! function(O, T, y, a) {
    O.fn.flipBook = function(e) {
        ...
        deeplinkingPrefix: "",
        assets: {
            preloader: "/public/images/preloader.jpg",
            overlay: "/public/images/overlay.png",
            flipMp3: "/public/mp3/turnPage.mp3",
        ...
        fillPreloader: {
            enabled: !1,
            imgEmpty: "/public/images/logo_light.png",
            imgFull: "/public/images/logo_dark.png"
        },
        logoImg: "",
        logoUrl: "",
        ...
        var rx = g3d.inx();
        if (document.domain != g3d.de("d3d3LmdhbGxlcnkzNjAuY28ua3I=")) {
            return
        };
        var n = this;
        ...
        updateCurrentPage: function() {
			...
			try{
				beforechangepage(this.currentPageValue);
			}catch(e){}
			...
			try{
				changepage(this.currentPageValue);
			}catch(e){}
        ...
        for (var e = y.getElementsByTagName("script"), t = 0; t < e.length; t++) {
            ...
            if (o.match("flipbook\\.js") || o.match("flipbook\\.min\\.js") || o.match("g3d\\.min\\.js")) return o;
