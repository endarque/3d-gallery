...
Pano.prototype = {
	"init" : function(target_layer, vr_key){
		...
		console.log(_self);
		embedpano({
			swf : "/static/gallery360/vr/vr/tour.swf",
			id : "krpanoSWFObject_" + 'jiwon@pabloarts.com_20220630094533_TLEES50',
			xml : "/static/gallery360/vr/vr/xml/tour_" + 'jiwon@pabloarts.com_20220630094533_TLEES50' + ".xml",
			target : target_layer, 
			consolelog : false,		
